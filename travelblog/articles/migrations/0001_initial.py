    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homepage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='frontend.homepage')),
        ...
        migrations.AddField(
            model_name='article',
            name='homepage',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='frontend.homepage'),
        ),
    ]
